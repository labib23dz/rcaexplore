...
public class FullImplicationComputation extends ImplicationComputation{
	public FullImplicationComputation(String string, IConceptOrder<GenericConcept> conceptOrder) {
