...
public class SimplifiedIntentListModel extends AbstractListModel<String> implements CLFListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	COFNavigationModel clf;
	ArrayList<Attribute> intent;
	public SimplifiedIntentListModel(COFNavigationModel clf) {
		clf.addCLFListener(this);
		this.clf=clf;
		intent=clf.getCustomSimplifiedIntent();
